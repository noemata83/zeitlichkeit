    ...
    return (
      <div className={classes.Landing}>
        ...
        <Paper classes={{ root: classes.TextBox }} elevation={8}>
          <h1 className={classes.HeaderText__brand}>
            Temporalite.
        ...
        <div className={classes.Footer}>
          ...
          >
            <a
              ...
              href="https://unsplash.com/@petradr?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge"
              target="_blank"
              rel="noopener noreferrer"
              title="Download free do whatever you want high-resolution photos from petradr"
            >
